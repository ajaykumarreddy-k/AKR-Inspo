export default function Icon({ cid }: { cid?: string }) {
  return (
    <svg className="w-auto h-7.5 block overflow-hidden align-middle focus:outline-clr-4 focus:[outline-style:auto] focus:outline-[5px]" data-component="icon" aria-hidden="true" height="1em" viewBox="0 0 36 30" width="1.2em" focusable="false" data-icon="logo-icon" fill="currentColor" data-cid={cid}>
      <g fill="none">
        ...
        <path stroke="url(#a)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.336" d="M12.988 21.127c1.764-.463 3.79-3.718 3.247-10.223a11 11 0 0 0-.218-1.46" opacity=".5" />
        ...
        <path stroke="url(#b)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.336" d="M24.574 13.08c1.336 5.053-.641 12.164-3.877 11.006" opacity=".5" />
        ...
        <defs>
          <linearGradient id="a" x1="16.35" x2="15.661" y1="18.015" y2="10.005" gradientUnits="userSpaceOnUse">
            <stop stopColor="#8ED462" />
            <stop offset="1" stopColor="#368D32" />
          </linearGradient>
          <linearGradient id="b" x1="25.354" x2="24.614" y1="23.015" y2="13.372" gradientUnits="userSpaceOnUse">
            <stop stopColor="#8ED462" />
            <stop offset="1" stopColor="#368D32" />
          </linearGradient>
        </defs>
