export default function Illustration4({ cid }: { cid?: string }) {
  return (
    <svg className="w-full block absolute overflow-hidden align-middle h-full max-lg:hidden 2xl:hidden" data-component="image" id="desktop-svg" viewBox="0 0 1944.2 6151.5" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" fill="currentColor" data-cid={cid}>
