    ...
    >
      ...
      <div className="ln-footer-bottom">
        <p className="ln-footer-attribution">
          Self-Hosted Instance · Originally created with <AiFillHeart className="ln-footer-heart" /> by{' '}
          <a href="https://github.com/DavidHDev/react-bits" target="_blank" rel="noopener noreferrer" className="ln-footer-creator">
            David Haz (DavidHDev)
          </a>
        </p>
        <p className="ln-footer-copy">
          AKR-Cloned-Stored-React-Bits ·{' '}
          <a
