...
const UsefulLinks = ({ onClose }) => (
  <>
    ...
    <Flex direction="column" gap={2}>
      {[
        { to: 'https://github.com/DavidHDev/react-bits', label: 'Original Repository', external: true },
        { to: '/showcase', label: 'Showcase' },
        { to: 'https://github.com/DavidHDev/react-bits', label: 'Credit: DavidHDev', external: true }
