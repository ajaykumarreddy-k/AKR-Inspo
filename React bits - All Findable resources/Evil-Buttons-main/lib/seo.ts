...
export const siteConfig = {
  name: "AKR-Cloned-Stored-Evil-Buttons",
  shortName: "AKR-EvilButtons",
  tagline: "Animated shadcn/ui components with Motion (Self-Hosted Clone)",
  description:
    "Self-hosted instance of Evil Buttons registry of animated buttons, icons, logos, and scroll bars built with Motion.",
  url: (process.env.NEXT_PUBLIC_SITE_URL ?? DEFAULT_SITE_URL).replace(/\/$/, ""),
  locale: "en_US",
  github: "https://github.com/radiumcoders/evil-buttons",
  author: {
    name: "Original Creator: Radium Coders",
