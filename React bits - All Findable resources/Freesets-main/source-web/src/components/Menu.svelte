		...
		<ul>
			...
			<li>
				<a
					...
					class="transition-colors rounded-b-md group w-full hover:bg-zinc-800 px-3.5 py-2 flex items-center gap-2.5 text-xs text-zinc-300"
				>
					<img
						src={externalLinkIcon}
						alt=""
						class="w-4 opacity-80 group-hover:opacity-100 invert transition-all"
					/>
					Credit: Cosmo (Original Project)
				</a>
			</li>
		</ul>
	</nav>
