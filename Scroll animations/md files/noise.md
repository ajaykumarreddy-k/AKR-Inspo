  ...
  return (
    <>
      <section className='relative border rounded-lg w-full'>
        ...
        <div
          className="absolute top-0 left-0 w-full h-full content-[''] z-10 pointer-events-none bg-[url('https://framerusercontent.com/images/rR6HYXBrMmX4cTwEXZGUQ8wG4.gif')]"
